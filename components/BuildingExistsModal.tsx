...
interface BuildingExistsModalProp {
  buildingAddress: string
}

const BuildingExistsModal: React.FC = (props) => {
  return (
    <div
      ...
      <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            ...
            <div className="sm:flex sm:items-start">
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h3 className="text-lg leading-6 font-medium text-gray-900" id="dialog-1-title">
                  You're in luck, that community exists
                </h3>
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    {props.buildingAddress} residents are already chatting! Sign up below
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            ...
            <button
              type="button"
              onClick={() => props.setShowBuildingModal(false)}
...
export default BuildingExistsModal
